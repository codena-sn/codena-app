...
class Settings(BaseModel):
    ...
    # Utilise DATABASE_URL (Postgres sur Render) si defini, sinon SQLite local.
    # SQLAlchemy 2.0 exige le schema "postgresql://" (Render fournit "postgres://").
    db_url: str = os.getenv("DATABASE_URL", "sqlite:///codena.db").replace("postgres://", "postgresql://", 1)
